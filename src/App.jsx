...
import HotelDetails from "./components/pages/client/Hotels/HotelDetails";
import ManageReviewHotel from "./components/pages/admin/ManageReviewHotel";
import BlogDetail from "./components/pages/client/Blog/Details";
