...
export default function ReviewHotel({ reviews, hotelId }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await axiosInstance.post(
        `${import.meta.env.VITE_API_URL}/user/hotels/review`,
        formData,
        {
          headers: {
          ...
          >
            <div className="flex items-center gap-4">
              {review.Users?.avatar ? (
                ...
                <Avatar className="!bg-[#87d068] w-10 h-10 flex items-center justify-center text-base font-semibold">
